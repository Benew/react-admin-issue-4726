...
const PostEdit = ({ permissions, ...props }) => (
  <Edit title={<PostTitle />} actions={<EditActions />} {...props}>
    <TabbedForm initialValues={{ average_note: 0 }} warnWhenUnsavedChanges>
      ...
      <FormTab label="post.form.i18n">
        <TextField source="i18n[0].language" />
        <TextInput source="i18n[0].content" />
        <TextField source="i18n[1].language" />
        <TextInput source="i18n[1].content" />
      </FormTab>
    </TabbedForm>
  </Edit>
);
